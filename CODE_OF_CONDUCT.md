...
possible violation, please report it promptly:

- **Email (preferred):** [conduct@tsera.dev](mailto:conduct@tsera.dev)
- **Discord (private):** DM the **@Moderator** or **@Admin**
- **Security issues:** do **not** use this form; follow our procedure on
  [SECURITY.md](SECURITY.md)

We acknowledge reports within **48 hours** and will keep details confidential to
the extent possible. If you’re uncomfortable using the above channels, you may
request an **anonymous intake**; we will provide a temporary form on request.
...
Moderators recuse themselves from any report where they have a conflict of
interest.

### No Retaliation

Retaliation against anyone who reports a concern or participates in an
investigation is itself a violation of this Code.

### Privacy & Data Retention

Case data is shared only with Moderators handling the report and retained for up
to **12 months**, unless needed for an ongoing case or legal obligation.

### Appeals

If you believe an enforcement action was made in error, you may appeal by
emailing [conduct@tsera.dev](mailto:conduct@tsera.dev) within **14 days**. A
different set of Moderators will review the case.
