...
Deno.test("hashBytes - computes SHA-256 hash of a Uint8Array", async () => {
...
Deno.test("hashBytes - handles buffers with offset", async () => {
...
Deno.test("hashBytes - empty hash for empty array", async () => {
...
Deno.test("hashText - computes hash of a string", async () => {
...
Deno.test("hashText - empty hash for empty string", async () => {
...
Deno.test("hashText - handles unicode characters", async () => {
...
Deno.test("hashValue - hash with version and value", async () => {
...
Deno.test("hashValue - differentiates versions", async () => {
...
Deno.test("stableStringify - sorts object keys", () => {
...
Deno.test("stableStringify - preserves array order", () => {
  const obj = { arr: [3, 1, 2] };
  const result = stableStringify(obj);
...
Deno.test("stableStringify - handles arrays of objects", () => {
...
Deno.test("stableStringify - converts Date to ISO string", () => {
...
Deno.test("stableStringify - converts BigInt to string", () => {
...
Deno.test("stableStringify - handles null and undefined", () => {
  const obj = { a: null, b: undefined };
  const result = stableStringify(obj);

  // JSON.stringify removes undefined from objects
  assertEquals(result, '{"a":null}');
});

Deno.test("stableStringify - handles primitive types", () => {
...
Deno.test("stableStringify - complete determinism", () => {
  const obj = {
    z: { nested: [3, { z: 1, a: 2 }] },
    a: 42,
